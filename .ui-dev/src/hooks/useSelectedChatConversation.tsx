...
function useSelectedChatConversation(): Nullable<IChatConversation> {
  const value = useContext(SelectedChatConversationContext);
...
export default useSelectedChatConversation;
